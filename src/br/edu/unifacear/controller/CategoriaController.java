...
public class CategoriaController {
	...
	public void salvar() {
		...
		context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Categoria salva com sucesso", ""));
	}
	...
	public void remover() {
		...
		context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Categoria removida com sucesso", ""));
	}
