...
public class MarcaController {
	...
	public void salvar() {
		...
		try {
			...
			carregarComboBox();
			context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Marca salva com sucesso!", ""));
	...
	public void remover() {
		...
		try {
			...
			carregarComboBox();
			context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_INFO, "Marca removida com sucesso!", ""));
