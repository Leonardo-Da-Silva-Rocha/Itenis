...
public class FornecedorController {
	...
	public void salvar() {
		...
		try {
			...
			carregarCombo();
			context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Fornecedor salvo com sucesso", ""));
	...
	public void alterar() {
		...
		try {
			...
			context.addMessage(null,
					new FacesMessage(FacesMessage.SEVERITY_ERROR, "Fornecedor Alterado com sucesso", ""));
	...
	public void remover() {
		...
		try {
			...
			carregarCombo();
			context.addMessage(null,
					new FacesMessage(FacesMessage.SEVERITY_ERROR, "Fornecedor removido com sucesso", ""));
